...
-- -----------------------------------------------------
-- Table `goodfoodold`.`customers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`customers` (
...
DELETE FROM `goodfoodold`.`customers`;


-- -----------------------------------------------------
-- Table `goodfoodold`.`employees`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`employees` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`employees`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`privileges` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `privilege_name` VARCHAR(50) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`privileges`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`employee_privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`employee_privileges` (
  ...
  CONSTRAINT `fk_employee_privileges_employees1`
    ...
    REFERENCES `goodfoodold`.`employees` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employee_privileges_privileges1`
    FOREIGN KEY (`privilege_id`)
    REFERENCES `goodfoodold`.`privileges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`employee_privileges`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`inventory_transaction_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`inventory_transaction_types` (
  `id` TINYINT(4) NOT NULL,
  `type_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`inventory_transaction_types`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`shippers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`shippers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`shippers`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`orders_tax_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`orders_tax_status` (
  `id` TINYINT(4) NOT NULL,
  `tax_status_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`orders_tax_status`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`orders_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`orders_status` (
  `id` TINYINT(4) NOT NULL,
  `status_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`orders_status`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_orders_customers`
    ...
    REFERENCES `goodfoodold`.`customers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_orders_shippers1`
    ...
    REFERENCES `goodfoodold`.`shippers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_tax_status1`
    FOREIGN KEY (`tax_status_id`)
    REFERENCES `goodfoodold`.`orders_tax_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `goodfoodold`.`orders_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`orders`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`products` (
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`products`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`purchase_order_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`purchase_order_status` (
  `id` INT(11) NOT NULL,
  `status` VARCHAR(50) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`purchase_order_status`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`suppliers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`suppliers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`suppliers`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`purchase_orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`purchase_orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_orders_purchase_order_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `goodfoodold`.`purchase_order_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_purchase_orders_suppliers1`
    FOREIGN KEY (`supplier_id`)
    REFERENCES `goodfoodold`.`suppliers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`purchase_orders`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`inventory_transactions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`inventory_transactions` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_inventory_transactions_orders1`
    ...
    REFERENCES `goodfoodold`.`orders` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventory_transactions_products1`
    FOREIGN KEY (`product_id`)
    REFERENCES `goodfoodold`.`products` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventory_transactions_purchase_orders1`
    FOREIGN KEY (`purchase_order_id`)
    REFERENCES `goodfoodold`.`purchase_orders` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inventory_transactions_inventory_transaction_types1`
    FOREIGN KEY (`transaction_type`)
    REFERENCES `goodfoodold`.`inventory_transaction_types` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`inventory_transactions`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`invoices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`invoices` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`invoices`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`order_details_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`order_details_status` (
  `id` INT(11) NOT NULL,
  `status_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`order_details_status`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_order_details_order_details_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `goodfoodold`.`order_details_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`order_details`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`purchase_order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`purchase_order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_order_details_inventory_transactions1`
    ...
    REFERENCES `goodfoodold`.`inventory_transactions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`purchase_order_details`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`sales_reports`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`sales_reports` (
...
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`sales_reports`;

-- -----------------------------------------------------
-- Table `goodfoodold`.`strings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `goodfoodold`.`strings` (
  `string_id` INT(11) NOT NULL AUTO_INCREMENT,
  `string_data` VARCHAR(255) NULL DEFAULT NULL,
  PRIMARY KEY (`string_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
DELETE FROM `goodfoodold`.`strings`;
